...
function usage() {
  process.stdout.write(`Usage: node scripts/publish.js [--dry-run]

Build Ant Desktop and publish the platform and root packages to npm and
ants.land. Platform packages are always published before ant-desktop.
...
async function main() {
  ...
  process.stdout.write(
    options.dryRun
      ...
      : `\nPublished Ant Desktop ${rootPackage.version} to npm and ants.land.\n`
  );
}
