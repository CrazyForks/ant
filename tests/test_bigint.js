...
test('0n < -9007199254740992', 0n < -9007199254740992, false);
test('0n > 9007199254740992', 0n > 9007199254740992, false);
test('1n < 1.5', 1n < 1.5, true);
test('2n > 1.5', 2n > 1.5, true);
test('9007199254740993n > 9007199254740992', 9007199254740993n > 9007199254740992, true);
test('9007199254740993n <= 9007199254740992', 9007199254740993n <= 9007199254740992, false);
test('9007199254740992 < 9007199254740993n', 9007199254740992 < 9007199254740993n, true);
test('9007199254740992 >= 9007199254740993n', 9007199254740992 >= 9007199254740993n, false);
const pow100 = 1n << 100n;
test('(1n << 100n) <= 2 ** 100', pow100 <= 2 ** 100, true);
test('((1n << 100n) + 1n) > 2 ** 100', (pow100 + 1n) > 2 ** 100, true);
test('-2n < -1.5', -2n < -1.5, true);
test('-1n > -1.5', -1n > -1.5, true);
test('1n < Infinity', 1n < Infinity, true);
test('1n > -Infinity', 1n > -Infinity, true);
test('1n < NaN', 1n < NaN, false);
