...
#define STR_META_ASCII_SHIFT  56u
#define STR_META_UTF16_MASK   ((UINT64_C(1) << STR_META_ASCII_SHIFT) - 1u)
#define STR_META_ASCII_MASK   (~STR_META_UTF16_MASK)
#define STR_UTF16_LEN_UNKNOWN STR_META_UTF16_MASK
...
_Static_assert(sizeof(ant_flat_string_t) == 16, "flat string header must remain 16 bytes");
_Static_assert(
