...
OP_DEF(  DEFINE_SLOT,       7,   2,   1, atom)      /* obj val -> obj (atom + slot:u16; store into pre-shaped slot) */
...
#ifdef OP_FLAG
OP_FLAG(CONST                 , SV_OPF_JIT_ELIGIBLE | SV_OPF_JIT_INLINEABLE)
OP_FLAG(CONST_I8              , SV_OPF_JIT_ELIGIBLE | SV_OPF_JIT_INLINEABLE)
OP_FLAG(CONST8                , SV_OPF_JIT_ELIGIBLE | SV_OPF_JIT_INLINEABLE)
OP_FLAG(UNDEF                 , SV_OPF_JIT_ELIGIBLE | SV_OPF_JIT_INLINEABLE)
OP_FLAG(NULL                  , SV_OPF_JIT_ELIGIBLE | SV_OPF_JIT_INLINEABLE)
OP_FLAG(TRUE                  , SV_OPF_JIT_ELIGIBLE | SV_OPF_JIT_INLINEABLE)
OP_FLAG(FALSE                 , SV_OPF_JIT_ELIGIBLE | SV_OPF_JIT_INLINEABLE)
...
OP_FLAG(DUP                   , SV_OPF_JIT_ELIGIBLE | SV_OPF_JIT_INLINEABLE)
...
OP_FLAG(GET_LOCAL             , SV_OPF_JIT_ELIGIBLE | SV_OPF_JIT_INLINEABLE)
OP_FLAG(PUT_LOCAL             , SV_OPF_JIT_ELIGIBLE | SV_OPF_JIT_INLINEABLE | SV_OPF_JIT_LOCAL_NUMERIC_BAILOUT)
OP_FLAG(SET_LOCAL             , SV_OPF_JIT_ELIGIBLE | SV_OPF_JIT_INLINEABLE | SV_OPF_JIT_LOCAL_NUMERIC_BAILOUT)
OP_FLAG(GET_LOCAL8            , SV_OPF_JIT_ELIGIBLE | SV_OPF_JIT_INLINEABLE)
OP_FLAG(PUT_LOCAL8            , SV_OPF_JIT_ELIGIBLE | SV_OPF_JIT_INLINEABLE | SV_OPF_JIT_LOCAL_NUMERIC_BAILOUT)
OP_FLAG(SET_LOCAL8            , SV_OPF_JIT_ELIGIBLE | SV_OPF_JIT_INLINEABLE | SV_OPF_JIT_LOCAL_NUMERIC_BAILOUT)
OP_FLAG(SET_LOCAL_UNDEF       , SV_OPF_JIT_ELIGIBLE)
OP_FLAG(GET_SLOT_RAW          , SV_OPF_JIT_ELIGIBLE)
...
OP_FLAG(PUT_UPVAL             , SV_OPF_JIT_ELIGIBLE)
...
OP_FLAG(MUL                   , SV_OPF_JIT_ELIGIBLE | SV_OPF_JIT_INLINEABLE | SV_OPF_JIT_NEEDS_BAILOUT)
OP_FLAG(DIV                   , SV_OPF_JIT_ELIGIBLE | SV_OPF_JIT_INLINEABLE | SV_OPF_JIT_NEEDS_BAILOUT)
OP_FLAG(ADD_NUM               , SV_OPF_JIT_ELIGIBLE | SV_OPF_JIT_INLINEABLE | SV_OPF_JIT_NEEDS_BAILOUT)
OP_FLAG(SUB_NUM               , SV_OPF_JIT_ELIGIBLE | SV_OPF_JIT_INLINEABLE | SV_OPF_JIT_NEEDS_BAILOUT)
OP_FLAG(MUL_NUM               , SV_OPF_JIT_ELIGIBLE | SV_OPF_JIT_INLINEABLE | SV_OPF_JIT_NEEDS_BAILOUT)
OP_FLAG(DIV_NUM               , SV_OPF_JIT_ELIGIBLE | SV_OPF_JIT_INLINEABLE | SV_OPF_JIT_NEEDS_BAILOUT)
OP_FLAG(MOD                   , SV_OPF_JIT_ELIGIBLE | SV_OPF_JIT_INLINEABLE | SV_OPF_JIT_NEEDS_BAILOUT)
OP_FLAG(NEG                   , SV_OPF_JIT_ELIGIBLE | SV_OPF_JIT_INLINEABLE | SV_OPF_JIT_NEEDS_BAILOUT)
OP_FLAG(INC                   , SV_OPF_JIT_ELIGIBLE | SV_OPF_JIT_NEEDS_INC_LOCAL)
OP_FLAG(DEC                   , SV_OPF_JIT_ELIGIBLE | SV_OPF_JIT_NEEDS_INC_LOCAL)
OP_FLAG(POST_INC              , SV_OPF_JIT_ELIGIBLE | SV_OPF_JIT_NEEDS_INC_LOCAL)
OP_FLAG(POST_DEC              , SV_OPF_JIT_ELIGIBLE | SV_OPF_JIT_NEEDS_INC_LOCAL)
...
OP_FLAG(STR_APPEND_LOCAL      , SV_OPF_JIT_ELIGIBLE | SV_OPF_JIT_NEEDS_BAILOUT)
OP_FLAG(STR_ALC_SNAPSHOT      , SV_OPF_JIT_ELIGIBLE | SV_OPF_JIT_NEEDS_BAILOUT)
OP_FLAG(STR_FLUSH_LOCAL       , SV_OPF_JIT_NEEDS_BAILOUT)

OP_FLAG(EQ                    , SV_OPF_JIT_ELIGIBLE | SV_OPF_JIT_INLINEABLE)
OP_FLAG(NE                    , SV_OPF_JIT_ELIGIBLE | SV_OPF_JIT_INLINEABLE)
OP_FLAG(SEQ                   , SV_OPF_JIT_ELIGIBLE | SV_OPF_JIT_INLINEABLE)
OP_FLAG(SNE                   , SV_OPF_JIT_ELIGIBLE | SV_OPF_JIT_INLINEABLE)
OP_FLAG(LT                    , SV_OPF_JIT_ELIGIBLE | SV_OPF_JIT_INLINEABLE | SV_OPF_JIT_NEEDS_BAILOUT)
OP_FLAG(LE                    , SV_OPF_JIT_ELIGIBLE | SV_OPF_JIT_INLINEABLE | SV_OPF_JIT_NEEDS_BAILOUT)
OP_FLAG(GT                    , SV_OPF_JIT_ELIGIBLE | SV_OPF_JIT_INLINEABLE | SV_OPF_JIT_NEEDS_BAILOUT)
OP_FLAG(GE                    , SV_OPF_JIT_ELIGIBLE | SV_OPF_JIT_INLINEABLE | SV_OPF_JIT_NEEDS_BAILOUT)
OP_FLAG(INSTANCEOF            , SV_OPF_JIT_ELIGIBLE | SV_OPF_JIT_NEEDS_IC_EPOCH)
OP_FLAG(IN                    , SV_OPF_JIT_ELIGIBLE)

OP_FLAG(BAND                  , SV_OPF_JIT_ELIGIBLE | SV_OPF_JIT_NEEDS_BAILOUT)
OP_FLAG(BOR                   , SV_OPF_JIT_ELIGIBLE | SV_OPF_JIT_NEEDS_BAILOUT)
OP_FLAG(BXOR                  , SV_OPF_JIT_ELIGIBLE | SV_OPF_JIT_NEEDS_BAILOUT)
OP_FLAG(BNOT                  , SV_OPF_JIT_ELIGIBLE | SV_OPF_JIT_NEEDS_BAILOUT)
OP_FLAG(SHL                   , SV_OPF_JIT_ELIGIBLE | SV_OPF_JIT_NEEDS_BAILOUT)
OP_FLAG(SHR                   , SV_OPF_JIT_ELIGIBLE | SV_OPF_JIT_NEEDS_BAILOUT)
OP_FLAG(USHR                  , SV_OPF_JIT_ELIGIBLE | SV_OPF_JIT_NEEDS_BAILOUT)
...
OP_FLAG(JMP                   , SV_OPF_JIT_ELIGIBLE | SV_OPF_JIT_INLINEABLE | SV_OPF_JIT_BRANCH32 | SV_OPF_JIT_OSR_BACKEDGE)
OP_FLAG(JMP_FALSE             , SV_OPF_JIT_ELIGIBLE | SV_OPF_JIT_INLINEABLE | SV_OPF_JIT_BRANCH32 | SV_OPF_JIT_OSR_BACKEDGE)
OP_FLAG(JMP_TRUE              , SV_OPF_JIT_ELIGIBLE | SV_OPF_JIT_INLINEABLE | SV_OPF_JIT_BRANCH32 | SV_OPF_JIT_OSR_BACKEDGE)
OP_FLAG(JMP_FALSE_PEEK        , SV_OPF_JIT_ELIGIBLE | SV_OPF_JIT_INLINEABLE | SV_OPF_JIT_BRANCH32 | SV_OPF_JIT_OSR_BACKEDGE)
OP_FLAG(JMP_TRUE_PEEK         , SV_OPF_JIT_ELIGIBLE | SV_OPF_JIT_INLINEABLE | SV_OPF_JIT_BRANCH32 | SV_OPF_JIT_OSR_BACKEDGE)
OP_FLAG(JMP_NOT_NULLISH       , SV_OPF_JIT_BRANCH32 | SV_OPF_JIT_OSR_BACKEDGE)
OP_FLAG(JMP8                  , SV_OPF_JIT_ELIGIBLE | SV_OPF_JIT_BRANCH8 | SV_OPF_JIT_OSR_BACKEDGE)
OP_FLAG(JMP_FALSE8            , SV_OPF_JIT_ELIGIBLE | SV_OPF_JIT_INLINEABLE | SV_OPF_JIT_BRANCH8 | SV_OPF_JIT_OSR_BACKEDGE)
OP_FLAG(JMP_TRUE8             , SV_OPF_JIT_ELIGIBLE | SV_OPF_JIT_INLINEABLE | SV_OPF_JIT_BRANCH8 | SV_OPF_JIT_OSR_BACKEDGE)

OP_FLAG(CALL                  , SV_OPF_JIT_ELIGIBLE | SV_OPF_JIT_NEEDS_ARGS_BUF)
...
OP_FLAG(APPLY                 , SV_OPF_JIT_ELIGIBLE | SV_OPF_JIT_NEEDS_ARGS_BUF)
OP_FLAG(NEW_APPLY             , SV_OPF_JIT_ELIGIBLE | SV_OPF_JIT_NEEDS_ARGS_BUF)
OP_FLAG(RETURN                , SV_OPF_JIT_ELIGIBLE | SV_OPF_JIT_INLINEABLE)
OP_FLAG(RETURN_UNDEF          , SV_OPF_JIT_ELIGIBLE | SV_OPF_JIT_INLINEABLE)
OP_FLAG(HALT                  , SV_OPF_JIT_ELIGIBLE)
...
OP_FLAG(DEFINE_METHOD_COMP    , SV_OPF_JIT_ELIGIBLE)
OP_FLAG(SET_NAME              , SV_OPF_JIT_ELIGIBLE)
OP_FLAG(SET_PROTO             , SV_OPF_JIT_ELIGIBLE)
OP_FLAG(TO_PROPKEY            , SV_OPF_JIT_ELIGIBLE)
OP_FLAG(IS_UNDEF              , SV_OPF_JIT_ELIGIBLE | SV_OPF_JIT_INLINEABLE)
OP_FLAG(IS_NULL               , SV_OPF_JIT_ELIGIBLE | SV_OPF_JIT_INLINEABLE)

OP_FLAG(SPECIAL_OBJ           , SV_OPF_JIT_ELIGIBLE | SV_OPF_JIT_INLINEABLE)
OP_FLAG(NOP                   , SV_OPF_JIT_ELIGIBLE | SV_OPF_JIT_INLINEABLE)
