...
OP_FLAG(INC                   , SV_OPF_JIT_ELIGIBLE | SV_OPF_JIT_NEEDS_BAILOUT | SV_OPF_JIT_NEEDS_INC_LOCAL)
...
OP_FLAG(IS_UNDEF_OR_NULL      , SV_OPF_JIT_ELIGIBLE | SV_OPF_JIT_INLINEABLE)
...
OP_FLAG(JMP_NOT_NULLISH       , SV_OPF_JIT_ELIGIBLE | SV_OPF_JIT_INLINEABLE | SV_OPF_JIT_BRANCH32 | SV_OPF_JIT_OSR_BACKEDGE)
